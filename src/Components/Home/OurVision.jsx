    ...
    <div className='bg-[#064C4C] h-auto flex flex-col md:flex-row items-center md:items-start py-10 px-6 md:px-32 pb-14'>
      ...
      <div className='w-full md:w-[38vw] mt-10 md:mt-5 md:ml-36'>
        ...
        <p className='pt-3 md:pt-5 text-[#e0e5e7] text-center md:text-left'>
          To redefine interior spaces with innovative designs and quality craftsmanship, creating functional and stylish environments that inspire.
        </p>
        ...
        <p className='pt-3 md:pt-5 text-[#e0e5e7] text-center md:text-left'>
          At Havabi Furniture, we hold integrity, creativity, and excellence at our core, ensuring every customer receives tailored solutions with exceptional service.
        </p>
      </div>
    </div>
  );
